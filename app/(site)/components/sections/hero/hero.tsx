          ...
          <div className="flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2 lg:pr-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                {ctas?.map((cta, key) => (
                  <Button
                    className="rounded-md bg-primary px-4 py-2 text-lg font-semibold text-white shadow-md hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-all duration-300 ease-in-out"
                    {...cta}
                    key={key}
                  />
                ))}
